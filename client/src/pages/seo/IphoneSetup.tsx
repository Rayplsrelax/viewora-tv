...
export default function IphoneSetup() {
  usePageView("seo_iphone_setup");
  return (
      ...
      <section className="pt-28 pb-12 px-6">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            How to Set Up Viewora TV on <span className="text-violet-400">iPhone & iPad</span>
          </h1>
          <p className="text-zinc-400 text-lg mb-8">
            Watch Viewora TV on your iPhone or iPad using Smarters Player Lite from the App Store, or use our web player in Safari.
          </p>

          <div className="space-y-8">
            <Card className="bg-zinc-900/50 border-zinc-800/50">
              <CardContent className="p-6">
                <h2 className="text-xl font-bold text-white mb-4">Option 1: Smarters Player Lite (Recommended)</h2>
                <ol className="space-y-3 text-zinc-300 list-decimal list-inside">
                  ...
                  <li>Search for <strong>"Smarters Player Lite"</strong></li>
                  <li>Download and install the app</li>
                  <li>Open the app and tap <strong>"Add User"</strong></li>
                  <li>Enter your credentials:
                    <ul className="ml-6 mt-2 space-y-1 list-disc">
                      <li><strong>Name:</strong> Any name (e.g., "My iPhone")</li>
            ...
            <Card className="bg-zinc-900/50 border-zinc-800/50">
              <CardContent className="p-6">
                ...
                <ol className="space-y-3 text-zinc-300 list-decimal list-inside">
                  <li>Open <strong>Safari</strong> (or any browser) on your iPhone/iPad</li>
                  <li>Go to <strong className="text-violet-300">https://watch.vieworatv.live/login</strong></li>
                  <li>Create a playlist name</li>
                  <li>Enter your <strong>Username</strong> and <strong>Password</strong> from your credentials email</li>
            ...
            <Card className="bg-zinc-900/50 border-zinc-800/50">
              <CardContent className="p-6">
                ...
                <p className="text-zinc-300">For the best experience on iOS, we recommend using a VPN app. This helps with connection stability and ensures smooth playback.</p>
              </CardContent>
            </Card>
          </div>
