          ...
          <div className="space-y-8">
            <Card className="bg-gradient-to-br from-violet-500/10 to-purple-500/10 border-violet-500/30">
              <CardContent className="p-6 text-center">
                ...
                <a href="http://162.0.216.135/playlists" target="_blank" rel="noopener noreferrer" className="text-xl font-mono text-violet-300 hover:text-violet-200 underline underline-offset-4">
