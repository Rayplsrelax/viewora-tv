          ...
          <div className="text-left bg-zinc-800/30 rounded-lg p-4 mb-6 border border-zinc-700/30">
            ...
            <ol className="space-y-2 text-sm text-zinc-400">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Or use the <a href="http://162.0.216.135/playlists" target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:underline">Web Player</a> (username & password only, no domain needed)</span>
              </li>
            </ol>
          </div>
